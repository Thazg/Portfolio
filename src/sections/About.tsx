...
export default function About() {
  return (
    <section id="about" className="py-32 w-full max-w-[1400px] px-6 md:px-12">
      <Reveal>
        <div className="mb-16">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        <Reveal>
          <div className="text-xl md:text-2xl text-muted-foreground leading-relaxed space-y-8 font-medium">
            ...
            <StaggerItem key={idx}>
              <Card className="bg-card/40 backdrop-blur-md border-border/50 hover:border-primary/50 hover:bg-secondary/20 transition-all duration-300 hover:-translate-y-1 shadow-lg">
                <CardContent className="p-8 flex flex-col items-center justify-center text-center h-full">
                  <span className="text-5xl lg:text-6xl font-bold text-primary mb-3">
                    {stat.value}
                  </span>
